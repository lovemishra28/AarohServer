 ...
 * an empty body is valid and means "use the field's latest reading and the
 * default agro-climatic context". Supplied values override those defaults:
 *
 *  - `reading_id`   pin the calculation to a specific stored reading instead of
 *                   the latest one for the field.
